...
export const victims: Record<string, Victim> = {
  "wv-001": {
    ...
    motherName: "Melissa Mitchell",
    motherAddress: "509 W HERRING ROAD MASONTOWN, WV 26542",
    classmates: [
      { name: "Daisy Marie Dalrymple", email: "dai*****.edu" },
      { name: "Sarah Lynn Lasko", email: "sara*****.edu" },
      { name: "Kaylin Shae Walton", email: "kay******.edu" },
      { name: "WVU WhatsApp Group", email: "" },
      { name: "All WVU Facebook Groups", email: "" },
      { name: "Morgantown Social Media Groups", email: "" },
